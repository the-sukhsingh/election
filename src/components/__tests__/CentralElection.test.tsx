...
import CentralElection from '../CentralElection';
...
describe('CentralElection Component', () => {
  it('renders the initial phase correctly', () => {
    render(<CentralElection />);
    expect(screen.getAllByText('The Signal').length).toBeGreaterThan(0);
    expect(screen.getAllByText('Every 5 years, the Election Commission triggers the world\'s largest democratic exercise, dividing India into 543 constituencies.').length).toBeGreaterThan(0);
  });
